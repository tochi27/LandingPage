...
const Button = ({ type, children, onClick}) => {
  switch (type) {
    case "primary":
        return <button className='flex items-center gap-3 border border-1 border-[#e0e0e0] px-6 py-2 rounded-3xl bg-white text-black hover:bg-[orange]' onClick={onClick}>{children}</button>
